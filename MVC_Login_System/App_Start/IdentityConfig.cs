...
namespace MVC_Login_System
{
    public class EmailService : IIdentityMessageService
    {
...

        {
            ...
            var client = new SendGridClient("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"); // https://app.sendgrid.com

            var msg = new SendGridMessage()

            {

                From = new EmailAddress("John@Outlook.com", "John One"),
